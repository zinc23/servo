...
use js::jsapi::{JS_GetFloat64ArrayData, JSContext};
...
use js::jsapi::{UnwrapFloat32Array, UnwrapFloat64Array};
...
use js::glue::{GetUint8ArrayLengthAndData, GetUint8ClampedArrayLengthAndData, GetFloat32ArrayLengthAndData};
